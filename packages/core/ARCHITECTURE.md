...
Derived from `packages/core/src`: **31 subsystems**, **703 files**, **138k lines**, **149 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 173 | 46k | 8 | 23 |
...
| `lib` | Shared primitives — fs, json, guards, scope globs, SSRF checks, clipboard | core | 20 | 2k | 25 | 0 |
...
| `chrome-bridge` | Localhost WebSocket bridge to the tsforge Chrome extension — read-only research in the user's browser | optional | 9 | 1k | 3 | 1 |
