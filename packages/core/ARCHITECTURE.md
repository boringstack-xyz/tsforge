...
Derived from `packages/core/src`: **32 subsystems**, **723 files**, **140k lines**, **153 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 174 | 46k | 8 | 24 |
...
| `site-plugins` | Built-in site experts (Reddit…) that read a site's structured data through the Chrome bridge | optional | 18 | 2k | 1 | 3 |
