...
Derived from `packages/core/src`: **31 subsystems**, **702 files**, **137k lines**, **149 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 172 | 46k | 8 | 23 |
