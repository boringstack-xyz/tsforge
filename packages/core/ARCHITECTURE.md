...
Derived from `packages/core/src`: **30 subsystems**, **687 files**, **134k lines**, **145 cross-subsystem edges**.
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 26 | 9k | 2 | 19 |
