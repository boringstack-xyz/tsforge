...
Derived from `packages/core/src`: **30 subsystems**, **686 files**, **134k lines**, **145 cross-subsystem edges**.
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 25 | 9k | 2 | 19 |
