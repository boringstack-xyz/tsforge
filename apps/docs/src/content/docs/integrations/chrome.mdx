...
For some sites tsforge knows a better way than reading rendered pages: it reads the site's own structured data through your logged-in tab. Plugins are built in and reviewed like any other tsforge code. [Reddit](/integrations/reddit/) is the first.
